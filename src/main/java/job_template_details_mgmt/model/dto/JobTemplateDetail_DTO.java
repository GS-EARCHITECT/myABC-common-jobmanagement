...
public class JobTemplateDetail_DTO implements Serializable 
{
	...
	public JobTemplateDetail_DTO(long jobTemplateSeqNo, long jobLevelNo, Long seqNo, Long jobSeqNo, long targetSeqNo,
