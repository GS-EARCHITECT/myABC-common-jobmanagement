package job_target_details.model.dto;
...
public class JobTargetDetail_DTO implements Serializable 
{
	...
	public JobTargetDetail_DTO(Long jobSeqNo, Long targetSeqNo, Float durDays, Float durHours,
			Float durMinutes, Float durMonths, Float durSeconds, Float durWeeks, Float duration,
			Float durationSeqNo, Float rateSeqNo, String remark, String status, Float unitRate) {
		super();
		this.jobSeqNo = jobSeqNo;
		this.targetSeqNo = targetSeqNo;
		this.durDays = durDays;
